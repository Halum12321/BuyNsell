			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li><a href="#">Dropdown Sales</a></li>
						<li><a href="#">Top Selling Items</a></li>
					</ul>
					<!-- /NAV -->
				</div>
				<!-- /responsive-nav -->
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6 stretch-card">
						<div class="shop">
							<div class="shop-img stretch-card" style="height: 280px;">
								<img src="img/accessories1.png"  alt="">
							</div>
							<div class="shop-body">
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab1">Tops</a></li>
									<li><a data-toggle="tab" href="#tab1">Bottoms</a></li>
