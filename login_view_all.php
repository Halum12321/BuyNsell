...
<?php 
	...
	<!-- SECTION top selling item-->
	<div class="section" id="topSelling_container">
		<!-- container -->
		<div class="container">
			<!-- row -->
			<div class="row">
				...
				<div class="col-md-12">
					<div class="section-title">
						<h3 class="title">TOP SELLING ITEM</h3>
					...
					<div class="row mb-3">
						<div class="products-tabs">
							...
							<div class="row">
								<!-- product top1-->
								<?php
								$query2 = "SELECT * FROM registered_product WHERE PURCHASE_NUMBER != 0 ORDER BY PURCHASE_NUMBER DESC";
	...
	<div class="section" id="topSale_container">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="section-title">
						<h3 class="title">FLASH SALE ITEM</h3>
						<hr style="border: 3px solid #EEFF01;border-radius: 5px;">
					</div>
				</div>
				<!-- /section title -->
					...
					<div class="row mb-3">
						<div class="products-tabs">
							...
							<div class="row">
								<!-- product top1-->
								<?php
								$query22 = "SELECT * FROM registered_product WHERE PERCENTAGE_NUM != 0 ORDER BY PERCENTAGE_NUM DESC";
									...
									?>
										...
										?>
											...
											<div class="col-md-3 mx-3" style="padding-bottom: 60px;margin-bottom: -60px;z-index: 2;">
												<div class="product">
													<div class="product-img" style="height: 260px;">
														<img src="ECS_ADMIN/<?php echo $imgs ?>" alt="" class="image_tops">
													</div>
													<div class="product-body">
														<p class="product-category"><?php echo $cat ?></p>
														<h3 class="product-name"><a href="#"><?php echo $pname ?></a></h3>
...
<?php
$term = $_REQUEST['viewItem'];

if ($term == 'topItem') {
	echo '<script>';

	echo 'document.getElementById("topSelling_container").style.display = "show";';
	echo 'document.getElementById("topSale_container").style.display = "none";';
	echo '</script>';
} else {
	echo '<script>';
	echo 'document.getElementById("topSelling_container").style.display = "none";';
	echo 'document.getElementById("topSale_container").style.display = "show";';
	echo '</script>';
}
?>