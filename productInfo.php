        ...
        <div class="container">
            ...
            <div id="responsive-nav">
                ...
                <ul class="main-nav nav navbar-nav">
                    ...
                    <li class="active"><a href="index.php#discover_container">Daily Discover</a></li>
                </ul>
                <!-- /NAV -->
            </div>
            <!-- /responsive-nav -->
            ...
            <div class="row">
                ...
                <div class="product col-md-7" style="padding: 20px;">
                    ...
                    <div class="row" style="margin-top: 20px; padding:10px; padding-left:60px">
                        ...
                        <div class="col-md-8">
                            <span><?php echo $_REQUEST['prodStock'] ?> pieces available </span>
                        </div>
                        <!---------------- buttons ----------------->
                        <div class="col-md-12" style="margin-top: 60px;">
                            <button class="btn" id="btn_addCart" onclick="location.href='SignIn.php'"><i class="fa fa-cart-plus"></i> Add to Cart</button>
                            <button class="btn" id="btn_buy" onclick="location.href='SignIn.php'">Buy Now</button>
                        </div>
                    </div>
                </div>
            </div>
