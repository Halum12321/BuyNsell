			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="breadcrumb-tree">
						...
						<li><a href="login_forship_orders.php" style="font-weight:bold; color:maroon">To Ship</a></li>
					...
					$firstName = $_SESSION['FIRST_NAME'];
					$lastName = $_SESSION['LAST_NAME'];
					$query2 = "SELECT * FROM purchase_basket WHERE PURCHASED_BY = '$firstName $lastName' AND STATUS = 'To Ship' ORDER BY DATE_PURCHASED DESC, TIME_PURCHASED DESC";
					...
					?><br>
						<center><span style="color: #01D1FF; font-weight:800; font-size:20px; margin-top:50PX">NO SHIP ITEM </span></center>
					<?php
					} ?>
				</div>
			</div>
