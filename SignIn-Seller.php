...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (is_array($row)) {
        ...
        if ($_SESSION["USER_TYPE"] == 'Admin') {
            ...
            if ($_SESSION["USER_TYPE"] == 'Buyer' &&  $_SESSION["ACCOUNT_STATUS"] == 'VERIFIED') {
                ...
                if ($_SESSION["USER_TYPE"] == 'Buyer' &&  $_SESSION["ACCOUNT_STATUS"] == 'NOT VERIFIED') {
                    //   header("location:Assoc_menuJIS.php");
                    header("location: ECS_ADMIN/verify_account.php");
                    die();
                }
            }
        }
                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1" data-aos="zoom-in">
                    <form method="POST">
                        ...
                        <div class="col-md-12 text-center">
                            <h2>BUY AND SELL Marketplace</h2> Grow your business and Sell more</p><br>
                        </div>
