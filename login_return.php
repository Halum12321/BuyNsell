		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<br><br>
			<h4>You have received item <?php echo $_REQUEST['pnamed'];?> with problem (Damage / Wrong Order).</h4>
				<div class="row">
				<div class="col-md-2">
										Reason to Return:
				</div>				
				<div class="col-md-10">
				<textarea name="reason" class="form-control" id="reason" cols="5" rows="2" autofocus></textarea>
				</div>		
				</div><br>
					<center><button class="btn btn-primary mx-1" id="cancelBtn">RETURN ITEM</button>
					...
					success: function(response) {
						if (response == 0) {
							Swal.fire({
									icon: 'success',
									title: 'Success',
									text: 'You have returned the item successfully'
								}).then((result) => {
									if (result.isConfirmed) {
