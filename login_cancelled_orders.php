			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="breadcrumb-tree">
						...
						<li><a href="login_cancelled_orders.php" style="font-weight:bold; color:maroon">Cancelled</a></li>
					...
					$firstName = $_SESSION['FIRST_NAME'];
					$lastName = $_SESSION['LAST_NAME'];
					$query2 = "SELECT * FROM purchase_basket WHERE PURCHASED_BY = '$firstName $lastName' AND STATUS = 'Cancelled' ORDER BY DATE_PURCHASED DESC, TIME_PURCHASED DESC";
					...
					?>
						<center><span style="color: #01D1FF; font-weight:800; font-size:20px">NO COMPLETED ITEM</span></center>
					<?php
					} ?>
				</div>
			</div>
