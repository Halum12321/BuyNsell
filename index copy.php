		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-4 col-xs-6 stretch-card">
					<div class="shop">
						<div class="shop-img stretch-card" style="height: 280px;">
							<img src="img/accessories1.png" alt="" class="image_tops">
						</div>
						<div class="shop-body">
					...
					<div class="section-title">
						...
						<div class="section-nav">
							<ul class="section-tab-nav tab-nav">
								<li class="active"><a data-toggle="tab" href="#tab1">See all ></a></li>
								</ul>
						</div>
					</div>
				</div>
						...
						<div class="products-tabs">
							...
							<div id="tab1" class="tab-pane active">
								<div class="products-slick" data-nav="#slick-nav-1">
									<!-- product top1-->
									<div class="product">
										<div class="product-img" style="height: 260px;" class="image_tops">
									...
									<div class="product">
										<div class="product-img" style="height: 260px;">
											<img src="img/dress2.jpg" alt="" class="image_tops">
											<div class="product-label">
												<span class="new">NEW</span>
											</div>
										</div>
									...
									<div class="product">
										<div class="product-img" style="height: 260px;">
											<img src="img/dress4.jpg" alt="" class="image_tops">
										</div>
										<div class="product-body">
											<p class="product-category">Category</p>
											<h3 class="product-name"><a href="#">product name goes here</a></h3>
									...
									<div class="product">
										<div class="product-img" style="height: 260px;">
											<img src="img/dress5.png" alt="" class="image_tops">
										</div>
										<div class="product-body">
											<p class="product-category">Category</p>
											<h3 class="product-name"><a href="#">product name goes here</a></h3>
									...
									<div class="product">
										<div class="product-img" style="height: 260px;">
											<img src="img/dress1.jpg" class="image_tops" alt="">
										</div>
										<div class="product-body">
											<p class="product-category">Category</p>
											<h3 class="product-name"><a href="#">product name goes here</a></h3>
