				...
				<div class="row">
					...
					<div class="col-md-3">
						...
						<div class="header-logo">
							<a href="http://localhost/Buy_Sell/Buyer_index.php#home" class="logo mt-3 text-white">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<br><br>
					<center><h4>Are you sure you want to cancel item <?php echo $_REQUEST['pnamed'];?>?</h4></center><br>
					<center><button class="btn btn-primary mx-1" id="cancelBtn">YES,CANCEL</button>
						...
						if (response == 0) {
							Swal.fire({
									...
									if (result.isConfirmed) {
										location.href = "login_cancelled_orders.php"
									} else {
										return false;
									}
								});
