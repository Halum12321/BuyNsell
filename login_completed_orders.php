			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="breadcrumb-tree">
						...
						<li><a href="login_completed_orders.php" style="font-weight:bold; color:maroon">Completed</a></li>
					...
					$firstName = $_SESSION['FIRST_NAME'];
					$lastName = $_SESSION['LAST_NAME'];
					$query2 = "SELECT * FROM purchase_basket WHERE PURCHASED_BY = '$firstName $lastName' AND STATUS = 'Completed' ORDER BY DATE_PURCHASED DESC, TIME_PURCHASED DESC";
